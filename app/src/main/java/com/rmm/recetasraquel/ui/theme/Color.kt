...
// Warm dark scheme — Gate 70.
// The hierarchy is deliberately warm and visibly brown/espresso, never near-black.
// Five distinct surface levels prevent the interface from collapsing into one dark plane.
val NightBackground = Color(0xFF2A211B)
val NightSurface = Color(0xFF332820)
val NightSurfaceRaised = Color(0xFF3D3027)
val NightSurfaceHigh = Color(0xFF49392E)
val NightSurfaceHighest = Color(0xFF554337)
...
val BronzeDarkContainer = Color(0xFF684118)
val GoldDarkContainer = Color(0xFF60491F)
val BlueDarkContainer = Color(0xFF1E4A68)
val RedDarkContainer = Color(0xFF73302A)
val NightOutline = Color(0xFFA89A8E)
