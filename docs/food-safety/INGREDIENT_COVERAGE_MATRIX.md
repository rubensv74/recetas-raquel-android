...
This matrix separates research coverage from catalog population.
...
| Fruit/vegetable allergy groups | EFSA/AESAN | 0 | 0 | targeted review |
...
Generic entries for crustaceans, fish and molluscs are intentional: species expansion is deferred until the identity/taxonomy source for each culinary ingredient is explicitly reviewed rather than inferred from model knowledge.
